...
JSNES.Keyboard.prototype = {
    setKey: function(key, value) {
        switch (key) {
            ...
            case 87: this.state1[this.keys.KEY_UP] = value; break;     // Up W
            case 40: this.state1[this.keys.KEY_DOWN] = value; break;   // Down D
            case 83: this.state1[this.keys.KEY_DOWN] = value; break;   // Down
            case 37: this.state1[this.keys.KEY_LEFT] = value; break;   // Left A
            case 65: this.state1[this.keys.KEY_LEFT] = value; break;   // Left
            case 39: this.state1[this.keys.KEY_RIGHT] = value; break;  // Right
            case 68: this.state1[this.keys.KEY_RIGHT] = value; break;  // Right D
